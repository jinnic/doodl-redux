    ...
    const renderButtons = () => {
        const popover = (
          <Popover className="popover-basic">
            <Popover.Content>
              <button className="delete-button" onClick={() => handleDelete(doodle.id)}>
        ...
        if (match) {
         return <span className="edit-delete"> 
          ...
          <svg onClick={handleClick} width="1.3em" height="1.3em" viewBox="0 0 16 16" className="align-bottom bi bi-download" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
